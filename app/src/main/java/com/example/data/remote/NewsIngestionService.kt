    ...
    fun getInitialSeedArticles(): List<NewsArticle> {
        ...
        return listOf(
            ...
            NewsArticle(
                ...
                url = "https://www.thehindu.com/news/national/digital-privacy-bill-passed",
            ...
            NewsArticle(
                ...
                description = "Leading semiconductor foundries achieve 90% wafer yields on next-generation architectures, boosting computing power while reducing thermal limits by 35%.",
                ...
                url = "https://techcrunch.com/2026/08/2nm-quantum-processors-production",
                imageUrl = "https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=800&q=80",
                source = "TechCrunch",
                author = "Ron Miller",
                publishedAt = now - 2 * hour,
                ...
                aiKeyPoints = "• 2nm node yields reach commercial viability at 90%.\n• 35% lower power consumption for battery-powered devices.\n• First consumer devices featuring the silicon scheduled for Q1 2027.",
            ...
            NewsArticle(
                ...
                url = "https://www.espn.com/athletics/story/_/id/world-championships-tokyo-100m",
                ...
                aiSummary30Sec = "The World Athletics 100m final in Tokyo concluded with an exhilarating sub-9.80s photo finish, breaking the championship record.",
